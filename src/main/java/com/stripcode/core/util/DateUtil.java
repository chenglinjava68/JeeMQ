 ...
 * 
 * @author Metro
 * @version $Id: DateUtil.java, v 0.1 2014年3月28日 上午8:58:11 wss Exp $
 */
public class DateUtil {
	 ...
	 * @return
	 */
	public static String getYearBetween(Date startDate, Date endDate){
		Calendar start = Calendar.getInstance();
		start.setTime(startDate);
		start.set(Calendar.HOUR_OF_DAY, 0);
		start.set(Calendar.MINUTE, 0);
		...
		Double year = n/1000/3600/24/365.0;
