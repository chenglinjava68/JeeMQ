 ...
 */
public class ExcelCommentsStyle {
    private Short fontBoldWeight = 900;
    private String fontName = "宋体";
    private Short fontHeight = 200;
    private Short borderTop = CellStyle.BORDER_THIN;
    private Short borderRight = CellStyle.BORDER_NONE;
    private Short borderBottom = CellStyle.BORDER_NONE;
    ...
    private Short alignment = CellStyle.ALIGN_RIGHT;
    private Short verticalalignment = CellStyle.VERTICAL_CENTER;
    private Short color = HSSFColor.GREY_80_PERCENT.index;
