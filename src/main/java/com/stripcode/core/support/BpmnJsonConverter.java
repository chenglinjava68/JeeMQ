 ...
 */
package com.stripcode.core.support;
...
/**
 * @author Metro
 * @modify  解决modeler发布的流程图，sequenceFlow不显示的问题
 */
public class BpmnJsonConverter implements EditorJsonConstants, StencilConstants, ActivityProcessor {
	
	protected static final Logger LOGGER = LoggerFactory.getLogger(org.activiti.editor.language.json.converter.BpmnJsonConverter.class);
