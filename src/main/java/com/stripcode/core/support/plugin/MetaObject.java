        ...
        if (method != null) {
            try {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("invoke setter of [{}] faild!", property);
                }
            }
        }
        ...
        if (fail2invoke) {
            ...
            if (null != field) {
                ...
                try {
                    ...
                    // 发生异常，放弃赋值
                    if (log.isDebugEnabled()) {
                        log.debug("set property [{}] to [{}] faild!", property, value);
                    }
                }
            }
        }
    ...
    public Object getValue(String property) {
        ...
        if (method != null) {
            try {
                ...
                // 标记调用出错
                if (log.isDebugEnabled()) {
                    log.debug("invoke getter of [{}] faild!", property);
                }
            }
        }
        ...
        if (fail2invoke) {
            ...
            if (null != field) {
                ...
                try {
                    ...
                    // 发生异常，放弃赋值
                    if (log.isDebugEnabled()) {
                        log.debug("get property [{}] faild!", property);
                    }
                }
            }
        }
        ...
        if (fieldCache.containsKey(cacheKey)) {
            ...
            while (null != startClass) {
                try {
                    ...
                    if (log.isDebugEnabled()) {
                        log.debug("Field not found:{}", cacheKey);
                    }
                } catch (SecurityException e) {
                    if (log.isDebugEnabled()) {
                        log.debug("SecurityException:{}", cacheKey);
                    }
                }
