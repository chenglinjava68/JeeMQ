 ...
 */
public class CreateOrModifyCsTaskCompletionDto extends BaseModel {

    @NotNull(message="市场授权优化ID不能为空")
    ...
    public void setOptimauthId(String optimauthId) {
        this.optimauthId = optimauthId == null ? null : optimauthId.trim();
    }
    ...
    public TCsTaskCompletion toModel() {
        TCsTaskCompletion tCsTaskCompletion = new TCsTaskCompletion();
        BeanUtils.copyProperties(this, tCsTaskCompletion);
