...
@Service
public class MessageStoreQueueListener implements ChannelAwareMessageListener {
    private final static Logger LOGGER = LoggerFactory.getLogger(MessageStoreQueueListener.class);
