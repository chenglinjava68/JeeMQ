 ...
 */
package com.stripcode.mybatis.act;

import java.util.Date;
import java.util.List;
import java.util.Map;

import com.stripcode.core.dto.common.Variable;
import com.stripcode.core.util.StringActUtils;
...
//	private Variable taskVars; 	// 流程任务变量
	...
	public String getProcDefKey() {
		if (StringActUtils.isBlank(procDefKey) && StringActUtils.isNotBlank(procDefId)){
			procDefKey = StringActUtils.split(procDefId, ":")[0];
		}
		return procDefKey;
	}
...
//	}
	...
	public boolean isFinishTask(){
		return "finish".equals(status) || StringActUtils.isBlank(taskId);
	}
