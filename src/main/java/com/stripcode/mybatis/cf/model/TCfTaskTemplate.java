package com.stripcode.mybatis.cf.model;

import java.io.Serializable;

public class TCfTaskTemplate implements Serializable {
    ...
    public String getPrevIsFinished() {
        return prevIsFinished;
    }

    public void setPrevIsFinished(String prevIsFinished) {
        this.prevIsFinished = prevIsFinished;
    }
